...
for (let coursesElement of coursesArray) {
    let divCurses = document.createElement('div');
    ...
    monthDurationDiv.innerText = `${coursesElement.monthDuration}`;
    let hourDurationDiv = document.createElement('div');
    hourDurationDiv.innerText = `${coursesElement.hourDuration}`;
    let modulesUl = document.createElement('ul');
    let modules = coursesElement.modules
    for (let module of modules) {
        let modulesLi = document.createElement('li');
        modulesLi.innerText = `${module}`
        modulesUl.append(modulesLi);
    }
    divCurses.append(titleDiv, monthDurationDiv, hourDurationDiv, modulesUl);
    document.body.append(divCurses);
    console.log(divCurses);
    }
